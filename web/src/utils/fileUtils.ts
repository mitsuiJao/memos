...
// heic/heif excluded: createImageBitmap does not support them in any mainstream browser.
export const COMPRESSIBLE_IMAGE_TYPES = new Set(["image/jpeg", "image/png", "image/bmp", "image/tiff", "image/webp", "image/avif"]);

// Resize and re-encode large images to reduce memory pressure on mobile browsers.
// Returns the original file unchanged if it is small, an unsupported type, or compression fails.
